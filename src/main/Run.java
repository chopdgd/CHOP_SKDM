...
public class Run {
	...
	public static void main(String[] args){
		try{
			...
			FileOutputStream foutLog = new FileOutputStream(Settings.WORKING_DIR + "logs/log.txt");
			...
			if (args == null){
				File f1 = new File(Settings.WORKING_DIR + "logs/pat.txt");
				File f2 = new File(Settings.WORKING_DIR + "logs/ctrl.txt");
				...
				if (args[0] != null && args[1] != null){
				    ...
				    fout = new FileOutputStream(Settings.WORKING_DIR + "logs/pat.txt");
				    new PrintStream(fout).println(args[0]);
				    fout.close();
				    fout = new FileOutputStream(Settings.WORKING_DIR + "logs/ctrl.txt");
